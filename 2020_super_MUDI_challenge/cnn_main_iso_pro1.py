...
trained_general_path = './trained_networks_testowanie2/'
...
# training data sets
training_data_path_in = './training_iso2/data2d_interp_iso_training/'  # input data
training_data_path_out = './training_iso2/data2d_iso_training/'  # output data (reference)
...
# data loaders
training_loader = DataLoader(dataset=trainset, batch_size=batch_size, shuffle=True, num_workers=12)
testing_loader = DataLoader(dataset=testset, batch_size=batch_size, shuffle=False, num_workers=12)
...
np.save(f'{trained_network_path}/training_stat.npy', training_stat)ls